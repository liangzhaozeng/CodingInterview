...
public class ParkingLot {
	...
	private PriorityQueue<ParkingSpace> pq = new PriorityQueue<ParkingLot.ParkingSpace>(maxFloors * maxSlotsPerFloor, new IntervalSorter());

	private class IntervalSorter implements Comparator<ParkingSpace> {
		
		// remember, priorityQueue is a min heap
		@Override
	...
	class ParkingSpace {
		...
		public boolean equals(Object obj) {
			if (obj instanceof ParkingSpace) {
				...
				return (this.getFloor() == ps.getFloor() && this.getSlot() == ps.getSlot());
			}
			return false;
		}
	}
