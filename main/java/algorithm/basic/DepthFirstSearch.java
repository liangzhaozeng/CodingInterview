 ...
 * the vertices connected to a given source vertex <em>s</em> in an undirected
 * graph. For versions that find the paths, see {@link DepthFirstPaths} and
 ...
 * is the number of vertices and <em>E</em> is the number of edges. It uses
